...
public class MusicScoreMax1 {
    ...
    public static  class MyReducer extends Reducer<Text, DoubleWritable, Music, DoubleWritable> {
        ...
        protected void reduce(Text key, Iterable<DoubleWritable> values, Context context) throws IOException, InterruptedException {
            ...
            music.setScore(Double.valueOf(max.toString()));
//            theMax.set(max);
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        job.setJarByClass(MusicScoreMax1.class);
        ...
        DBOutputFormat.setOutput(job,"music_score","year","score");
